                ...
                <div class="col-lg-7">
                    <div class="section-title">
                        <p class="text-primary text-uppercase fw-bold mb-3">
                            {{ !empty($aboutUsContent->main_title) ? $aboutUsContent->main_title : '' }}
                        </p>
                        <h2 class="h1 mb-4">{{ !empty($aboutUsContent->title) ? $aboutUsContent->title : '' }}</h2>
                        <div class="content pe-0 pe-lg-5">
                            {!! html_entity_decode($aboutUsContent->description) !!}
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <img loading="lazy" decoding="async" src="{{ Voyager::image( $aboutUsContent->image ) }}"
